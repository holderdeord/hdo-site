describe('HDO.widgets', function() {
    ...
    it('should create representative URLs', function () {
        ...
        expect(widget.widgetOptionsFor(element).url)
            .toEqual('http://www.holderdeord.no/representatives/maaa/widget?issues=1%2C2%2C3');

        element.setAttribute('data-issue-ids', '');
        element.setAttribute('data-issue-count', '3');
        expect(widget.widgetOptionsFor(element).url)
            .toEqual('http://www.holderdeord.no/representatives/maaa/widget?count=3');
    });
    ...
    it('should create topic URLs', function() {
        ...
        var expected = 'http://www.holderdeord.no/widgets/topic'
            + '?issues=1%2C2%2C3&promises[Samferdsel]=101%2C102&promises[Intercity]=103%2C104';
