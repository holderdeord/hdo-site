...
(function (H, $) {
  buster.testCase('Promises page', {
    ...
    "party filter should not change when choosing other categories": function () {
      var mockHtmlObject = $('<div id="categories"><a data-category-id="1">Arbeidsliv</a><a data-category-id="2">Finanser</a><</div><div class="party-nav"><li><a data-party-slug="show-all">Alle partiene</a></li><li class="a-active"><a data-party-slug="a">Arbeiderpartiet</a></li></div>');
