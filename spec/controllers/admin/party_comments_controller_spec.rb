...
describe Admin::PartyCommentsController do
  ...
  # Admin::PartyComment. As you add validations to Admin::PartyComment, be sure to
  ...
  # Admin::PartyCommentsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all admin_party_comments as @admin_party_comments" do
      party_comment = Admin::PartyComment.create! valid_attributes
  ...
  describe "GET show" do
    it "assigns the requested admin_party_comment as @admin_party_comment" do
      party_comment = Admin::PartyComment.create! valid_attributes
      get :show, {:id => party_comment.to_param}, valid_session
      assigns(:admin_party_comment).should eq(party_comment)
    end
  end

  describe "GET new" do
    it "assigns a new admin_party_comment as @admin_party_comment" do
  ...
  describe "GET edit" do
    it "assigns the requested admin_party_comment as @admin_party_comment" do
      party_comment = Admin::PartyComment.create! valid_attributes
      get :edit, {:id => party_comment.to_param}, valid_session
      assigns(:admin_party_comment).should eq(party_comment)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_party_comment as @admin_party_comment" do
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::PartyComment.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_party_comment" do
        ...
        Admin::PartyComment.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
      ...
      it "redirects to the admin_party_comment" do
        party_comment = Admin::PartyComment.create! valid_attributes
        put :update, {:id => party_comment.to_param, :admin_party_comment => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns the admin_party_comment as @admin_party_comment" do
        party_comment = Admin::PartyComment.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::PartyComment.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the admin_party_comments list" do
      party_comment = Admin::PartyComment.create! valid_attributes
      delete :destroy, {:id => party_comment.to_param}, valid_session
