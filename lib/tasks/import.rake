namespace :import do
  ...
  task :dump do
    sh "ssh hdo@hdo02.holderdeord.no 'pg_dump --clean hdo_production | gzip' | gunzip | psql hdo_development"
  end
end
