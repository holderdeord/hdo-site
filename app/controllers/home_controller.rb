...
class HomeController < ApplicationController
  ...
  def people
    @board = [
      ...
      Person.new('Morten Kjelkenes', nil, nil, 'sitter i Holder de ords styre. Morten jobber til daglig med prosjektledelse av både telecom- og IT-prosjekter, og har god teknisk erfaring innen konsolidering og virtualisering av tjenester for store kunder. Han har lang erfaring med kompliserte og heterogene miljøer og tjenester, samt fra oppbygging av testmiljøer for disse.'),
